...
# time curl -s http://localhost:8081/opendap/s3/dap/cloudydap/samples/GSSTFYC.3.Year.1988_2008.he5.dods\?Latitude,Longitude,Topography -o gsstf_local_d2_ll.bin


# echo 'Test GSSTF DODS subsetting (local).'
# time curl -s -g http://localhost:8081/opendap/s3/dap/cloudydap/samples/GSSTFYC.3.Year.1988_2008.he5.dods\?Topography\[0:20:179\]\[0:20:359\] -o gsstf_local_d2_ss.bin
