...
echo 'Test AIRS DAP4.'
time -p curl -s http://cloudydap.opendap.org:8080/opendap/arch2/airs/AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp.dap\?dap4.ce=Latitude\;Longitude\;Topography\&cloudydap=$CLOUDYDAP_TAG -o airs_d4_ll.bin

echo 'Test AIRS DAP4 subsetting.'
time -p curl -s -g http://cloudydap.opendap.org:8080/opendap/arch2/airs/AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp.dap\?dap4.ce=Topography\[0:20:179\]\[0:20:359\]\&cloudydap=$CLOUDYDAP_TAG -o airs_d4_ss.bin
