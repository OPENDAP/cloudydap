...
echo 'Test AIRS DMR.'
time -p curl -s http://$HYRAX:8080/opendap/arch3/airs/AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp.dmr -o airs.dmr

echo 'Test AIRS DAP4.'
UNQID=$(unique_id)
CLOUDYDAP=$UNQID"_"$CLOUDYDAP_TAG
time -p curl -s http://$HYRAX:8080/opendap/arch3/airs/AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp.dap\?dap4.ce=Latitude\;Longitude\;Topography\&cloudydap=$CLOUDYDAP -o airs_d4_ll.bin

echo 'Test AIRS DAP4 subsetting.'
UNQID=$(unique_id)
CLOUDYDAP=$UNQID"_"$CLOUDYDAP_TAG
time -p curl -s -g http://$HYRAX:8080/opendap/arch3/airs/AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp.dap\?dap4.ce=Topography\[0:20:179\]\[0:20:359\]\&cloudydap=$CLOUDYDAP -o airs_d4_ss.bin
...
# ---
# > <Dataset xmlns="http://xml.opendap.org/ns/DAP/4.0#" xml:base="http://$HYRAX:8080/s3/dap/arch3/airs/AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp" dapVersion="4.0" dmrVersion="1.0" name="AIRS.2015.01.01.L3.RetStd_IR001.v6.0.11.0.G15013155825.nc.h5.dmrpp">
